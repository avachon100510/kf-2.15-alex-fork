...
<xsl:for-each select="glitch">
    ...
    extern floatexp g_Cr;
    extern floatexp g_Ci;
...
<xsl:when test="derivative/@t='M'">
    ...
    const double1 Cr = double1(g_Cr);
    const double1 Ci = double1(g_Ci);
    const doubleN Ccr = Cr + cr0;
    const doubleN Cci = Ci + ci0;
    const complex&lt;double1&gt; C = { Cr, Ci };
    const complex&lt;doubleN&gt; Cc = { Ccr, Cci };
    (void) Cr; // -Wunused-variable
    (void) Ci; // -Wunused-variable
    (void) Ccr; // -Wunused-variable
    (void) Cci; // -Wunused-variable
    (void) C; // -Wunused-variable
    (void) Cc; // -Wunused-variable
...
<xsl:when test="perturbation/@t='C'">
      const complex&lt;double&gt; X = {Xr, Xi}, C = {Cr, Ci};
      const complex&lt;doubleN&gt; x = {xr, xi}, Xx = {Xxr, Xxi}, c = {cr, ci}, Cc = {Ccr, Cci};
      complex&lt;doubleN&gt; xn;
...
<xsl:when test="derivative/@t='C'">
      const complex&lt;double&gt; X = {Xr, Xi}, C = {Cr, Ci};
      const complex&lt;doubleN&gt; x = {xr, xi}, Xx = {Xxr, Xxi}, c = {cr, ci}, Cc = {Ccr, Cci}, d = {dr, di}, d0 = {daa, dba}; <!-- FIXME matrix derivatives -->
      complex&lt;doubleN&gt; dn;
...
<xsl:choose>
<xsl:when test="perturbation/@t='C'">
      const complex&lt;double1&gt; X = {Xr, Xi}, x = {xr, xi}, Xx = {Xxr, Xxi}, C = {Cr, Ci}, c = {cr, ci};
      complex&lt;double1&gt; xn;
      (void) X; (void) x; (void) Xx;
<xsl:choose>
<xsl:when test="derivative/@t='R' or derivative/@t='M'">
...
<xsl:choose>
<xsl:when test="derivative/@t='C'">
      const complex&lt;double1&gt; X = {Xr, Xi}, x = {xr, xi}, Xx = {Xxr, Xxi}, C = {Cr, Ci}, c = {cr, ci}, d = {dr, di}, d0 = {daa[k], dba[k]}; <!-- FIXME matrix derivatives -->
      complex&lt;double1&gt; dn;
      (void) X; (void) x; (void) Xx; (void) d;
@dc   {
        <xsl:value-of select="derivative" />
