...
{
  const dcomplex X = { Xr COMMA Xi } COMMA x = { xr COMMA xi } COMMA Xx = { Xxr COMMA Xxi } COMMA c = { cr COMMA ci } COMMA C = { Cr COMMA Ci } COMMA Cc = { Ccr COMMA Cci };
  dcomplex xn;
@cldc {
...
<xsl:when test="perturbation/@t='C'">
{
  const fecomplex X = { Xr COMMA Xi } COMMA x = { xr COMMA xi } COMMA Xx = { Xxr COMMA Xxi } COMMA c = { cr COMMA ci } COMMA C = { Cr COMMA Ci } COMMA Cc = { Ccr COMMA Cci };
  fecomplex xn;
@clfec  {
        <xsl:value-of select="perturbation" />
        }
