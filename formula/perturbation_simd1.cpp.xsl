...
<xsl:when test="perturbation/@t='C'">
      const complex&lt;double1&gt; X = {Xr, Xi}, C = {Cr, Ci};
      const complex&lt;doubleN&gt; x = {xr0, xi0}, Xx = {Xxr, Xxi}, Cc = {Ccr, Cci};
      complex&lt;doubleN&gt; xn;
...
<xsl:choose>
<xsl:when test="perturbation/@t='C'">
      const complex&lt;double1&gt; X = {Xr, Xi}, x = {xr0[k], xi0[k]}, Xx = {Xxr, Xxi}, c = { cr0[k], ci0[k] }, C = {Cr, Ci};
      complex&lt;double1&gt; xn;
      (void) X; (void) x; (void) Xx;
@dc   {
        <xsl:value-of select="perturbation" />
